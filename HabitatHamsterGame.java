...
public final class HabitatHamsterGame extends SimpleHamsterGame {
	...
	public HabitatHamsterGame() {
		...
		HouseWall wall1 = new HouseWall(new Location(1,1), new Location(1,7));
		HouseWall wall2 = new HouseWall(new Location(2, 1), new Location(6, 1));
		HouseWall wall3 = new HouseWall(new Location(6, 2), new Location(6, 9));
		HouseWall wall4 = new HouseWall(new Location(2, 7), new Location(2, 9));
		HouseWall wall5 = new HouseWall(new Location(2, 10), new Location(6, 10));
		wall1.addDoor(firstDoor);
		wall5.addDoor(secondDoor);
		houseBuilder.withWall(wall1);
		houseBuilder.withWall(wall2);
		houseBuilder.withWall(wall3);
		houseBuilder.withWall(wall4);
		houseBuilder.withWall(wall5);

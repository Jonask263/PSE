...
public final class HabitatHamsterGame extends SimpleHamsterGame {
	...
	public HabitatHamsterGame() {
		...
		Location firstDoor = new Location(1,3);
		Location secondDoor = new Location(4,10);
		HouseBuilder hausBauer = new HouseBuilder(territoryBuilder,game.getTerritory());
		Optional<Location> doorOptional1 = Optional.of(firstDoor);
		Optional<Location> doorOptional2 = Optional.of(secondDoor);
		hausBauer.withWall(new HouseWall(new Location(1,1), new Location(1,7), doorOptional1));
		hausBauer.withWall(new HouseWall(new Location(2, 1), new Location(6, 1),Optional.empty()));
		hausBauer.withWall(new HouseWall(new Location(6, 2), new Location(6, 9), Optional.empty()));
		hausBauer.withWall(new HouseWall(new Location(2, 7), new Location(2, 9), Optional.empty()));
		hausBauer.withWall(new HouseWall(new Location(2, 10), new Location(6, 10), doorOptional2));

		House haus = hausBauer.build();

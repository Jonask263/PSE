...
public final class HabitatHamsterGame extends SimpleHamsterGame {
	...
	public HabitatHamsterGame() {
		...
		houseBuilder.withWall(new HouseWall(new Location(1,1), new Location(1,7), doorOptional1));
		houseBuilder.withWall(new HouseWall(new Location(2, 1), new Location(6, 1),Optional.empty()));
		houseBuilder.withWall(new HouseWall(new Location(6, 2), new Location(6, 9), Optional.empty()));
		houseBuilder.withWall(new HouseWall(new Location(2, 7), new Location(2, 9), Optional.empty()));
		houseBuilder.withWall(new HouseWall(new Location(2, 10), new Location(6, 10), doorOptional2));
